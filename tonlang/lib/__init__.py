"""TON cekirdek kutuphanesi: hazir isler, yontemler ve modul yukleyici."""
...
def isim_alani(ad, uyeler, yorumlayici_isteyenler=()):
    """Python sozlugunden TON kutuphane nesnesi uretir."""
    cikti = {}
...
DIS_KUTUPHANELER = {"web": "tonweb", "tonweb": "tonweb"}
