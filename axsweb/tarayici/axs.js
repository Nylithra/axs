/*!
 * axs.js - Axs dilinin tarayici calisma zamani
 * Derlenmis Axs kodu bu dosyadaki `AXS` nesnesini kullanir.
  ...
  function ciktiya_yaz(metin) {
    if (typeof document !== "undefined") {
      var hedef = T.cikti_ogesi ||
        document.getElementById("axs-cikti") ||
        document.querySelector("[data-axs-cikti]");
      if (hedef) {
...
(function (global) {
  ...
  function hata_goster(e) {
    ...
    if (typeof document !== "undefined") {
      var kutu = document.getElementById("axs-hata");
      if (!kutu) {
      ...
      kutu.textContent = "Axs hatasi: " + mesaj;
    }
  }
  ...
  // <script type="text/axs"> bloklari: sunucudan derlenmis hali istenir
