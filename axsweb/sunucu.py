"""axsweb sunucusu: yollar, istekler, cevaplar."""
...
def yukle(y):
    ...
    def tarayici_js(yol="/axs.js"):
        """axs.js calisma zamanini yayinlar."""
    ...
    def ai_ucu(yol="/api/ai"):
        ...
        from axslang.lib.zeka import zeka
